  ...
  const updateData = async () => {
    ...
    if (result.message === "data updated") {
      ...
      swal({
        ...
        text: "Any change in your profile Completely cange your profile!",
        icon: "warning",
        buttons: true,
        dangerMode: true,
      })
      .then((willDelete) => {
        if (willDelete) {
          swal("congratulations! Your Profile had changed!", {
            icon: "success",
          });
        } else {
          swal("You can enter again previous data!");
        }
      });
    } else {
        ...
        <div className="imgBox">
          ...
          <div className="welcomeDiv">
            ...
            <p style={{ marginBottom: "0rem !important" }}>
              Exam Enrollment No. : {user.enrollment_no}
            </p>
