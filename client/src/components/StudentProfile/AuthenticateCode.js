...
const AuthenticateCode = () => {
  ...
  return (
    <>
      ...
      >
        <h2 style={{ fontWeight: "bolder",textAlign:'center' }}>EXAM Authenticate Code</h2>
        <div className="subClass">
          <div style={{ marginRight: "2rem", width: "50%" }}>
            <input
              id="subject"
              name="subject"
              placeholder="Enter subject of Exam"
              autoComplete="off"
              type="text"
          ...
          <div>
            <p style={{ fontWeight: "bold" }}>
              DEAR CANDIDATE, PLEASE ENTER THE AUTHENTICATION CODE TO MARK
              ATTENDANCE of your Exam!
            </p>
          </div>
        </div>
